...
export const SelectedPaymentMethod = () => {
  ...
  // Return null when there's no selected payment method or when adding a new card
  if (!selectedPaymentMethodId || !paymentMethod) {
    return null;
  }

  // Only render the payment method details when we have a valid payment method
  return (
    <div
