...
export const GoogleLoginButton = ({
  ...
  return googleClientId ? (
    <GoogleLogin
      ...
      onFailure={onFailure}
      render={(renderProps) => (
        <button onClick={renderProps.onClick} className="plc-group plc-relative plc-flex plc-items-center plc-justify-center plc-gap-2 plc-rounded-lg plc-border plc-border-gray-200 plc-bg-white plc-px-4 plc-py-3 plc-text-sm plc-font-medium plc-text-gray-700 plc-shadow-sm plc-transition-all hover:plc-bg-gray-50 hover:plc-shadow active:plc-bg-gray-100">
          <svg viewBox="0 0 24 24" aria-hidden="true" className="plc-h-5 plc-w-5">
            <path
