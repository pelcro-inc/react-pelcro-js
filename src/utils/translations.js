export default {
  en_US: {
    ...
    "password-reset": {
      ...
      required: "Required",
      passwordUpdated:
        "Password has been updated, please login with the new password"
    },
    "payment-create": {
    ...
    register: {
      ...
      messages: {
        ...
        preferDisable: {
          click: "Click",
          here: "here",
          ifPrefer: "if you prefer to disable your Ad blocker."
        }
      },
      errors: {
        "": ""
      ...
      gift: {
        titles: {
          firstTitle: "Gift this subscription",
          secondTitle: "Enter the recipients information below"
        },
        labels: {
        ...
        messages: {
          enterEmail: "Please enter the gift recepients email."
        }
      },
      redeem: {
        titles: {
    ...
    success: {
      ...
      messages: {
        ...
        youHaveAccess:
          "Hope you enjoy the subscription. Please contact us if you have any questions or concerns.",
        clickToLearn: {
          click: "Click",
          here: "here",
    ...
    cart: {
      ...
      subtitle: "Comple your purchase below",
      name: "Name",
      quantity: "Quantity",
      price: "Price",
      actions: "Actions",
    ...
    confirm: {
      ...
      labels: {
        ...
        subtitle: "Your items will be on their way shortly."
      }
    }
  },
  ...
  fr_CA: {
    ...
    "password-reset": {
      ...
      subtitle: "Entrez un nouveau mot de passe ci-dessous",
      email: "Courriel",
      password: "mot de passe",
    ...
    register: {
      ...
      redeem: {
        ...
        labels: {
          code: "Entrez le code du cadeau",
          codePlaceholder: "Code cadeau",

          required: "Champs obligatoires"
        },
        buttons: {
          redeem: "Échanger un cadeau"
        },
        footer: {
          click: "Cliquez",
          here: "ici",
          toAdd: "pour ajouter une adresse"
        }
      }
    },
    login: {
    ...
    cart: {
      title: "Votre Panier",
      subtitle: "Terminez votre achat ci-dessous",
      name: "Produit",
      quantity: "Quantité",
      price: "Prix",
      actions: "Actes",
    ...
    confirm: {
      ...
      labels: {
        ...
        subtitle: "Vos articles seront bientôt en route."
      }
    }
  }
};
