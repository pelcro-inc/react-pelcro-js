...
const getClassName = (variant, isFullWidth, disabled) => {
  const variantsClasses = {
    solid: `inline-flex items-center justify-center gap-2 px-6 py-2 font-bold tracking-wider text-white uppercase bg-primary-500 rounded focus:outline-none focus:ring-4 focus:ring-primary-300 text-md justify-items-center ${
      disabled ? "" : "hover:bg-primary-600"
    } disabled:bg-gray-400 disabled:cursor-not-allowed ${
      isFullWidth ? "w-full" : "w-max"
    }`,
    outline: `inline-flex items-center justify-center gap-2 px-6 py-2 font-bold uppercase text-primary-500 border border-primary-500 rounded focus:outline-none focus:ring-4 focus:ring-primary-300 text-md justify-items-center ${
